...
export const PaletteIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
  ...
  >
    <path
      d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12a9.96 9.96 0 0 0 2.258 6.33c.376.452.905.67 1.442.67h.6c1.118 0 1.881-1.133 1.476-2.192A3 3 0 0 1 10.5 12a3 3 0 1 1 0-6 3 3 0 0 1 2.776 1.868"
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
    ...
    <circle cx="14.5" cy="16" fill="currentColor" r="1.5" />
  </svg>
);
